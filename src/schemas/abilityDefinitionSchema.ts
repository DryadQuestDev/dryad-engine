...
export const AbilityDefinitionSchema = {
    ...
    debug_info: { type: 'boolean', tooltip: 'Developer-only readout: the raw value is listed on the ability card when dev mode is on and "Show Hidden Stats" is enabled. Players never see it. Use for tuning fields with no player-facing meaning (AI weights, internal flags).' },
