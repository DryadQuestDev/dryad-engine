...
export const DevSettingsSchema = {
    ...
    asset_folders: { type: 'string[]', tooltip: "A place where your assets are located in the 'assets/games_assets' folder. Only assets located in these folders will be included when compressing the game/mod. \n e.g: 'my_game/_core'. \n Note: you don't need to add engine_assets as they are part of the engine." },
