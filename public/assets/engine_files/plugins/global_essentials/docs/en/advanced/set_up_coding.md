...
| **Markdown docs** | Documentation lives inside each plugin's `docs/` folder in `.md` files AI can read and reference |
...
| Folder | Use for |
|--------|---------|
| `engine_files/plugins/global_essentials/docs/` | Core engine documentation (the docs you're reading right now) |
| `engine_files/plugins/[plugin]/docs/` | Other plugin documentation (e.g., auto_battler, gender_pov) |
...
- ->builtins.game_emitters - Game emitters reference
