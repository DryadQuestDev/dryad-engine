...
- **All documentation lives in Markdown (`.md`) files** inside each plugin's `docs/` folder (e.g., `engine_files/plugins/global_essentials/docs/`), so an AI agent can read, reference, and update it alongside the plugin code.
